...
{
    sf::Window window(sf::VideoMode(WINDOW_WIDTH, WINDOW_HEIGHT), "Nuklear SFML");
    struct nk_color background;
    struct nk_context *ctx;
    float bg[4];

    ctx = nk_sfml_init(&window); // todo
    ...
    while (window.isOpen())
    {
        ...
        nk_sfml_render(nk_rgb(30,30,30));
    }
