...
NK_API void                 nk_sfml_handle_event(sf::Event *event);
NK_API void                 nk_sfml_render(struct nk_color clear);
...
static void
nk_sfml_scissor(SDL_Surface *surface, float x, float y, float w, float h)
{
    sdl_clip_rect.x = x;
    sdl_clip_rect.y = y;
    sdl_clip_rect.w = w  + 1;
...
static void
nk_sfml_stroke_rect(SDL_Surface *surface, short x, short y, unsigned short w,
...
static void
nk_sfml_fill_rect(SDL_Surface *surface, short x, short y, unsigned short w,
...
static void
nk_sfml_fill_triangle(SDL_Surface *surface, short x0, short y0, short x1, short y1, short x2, short y2, struct nk_color col)
{
    filledTrigonRGBA(surface, x0, y0, x1, y1, x2, y2, col.r, col.g, col.b, col.a);
}

static void
nk_sfml_stroke_triangle(SDL_Surface *surface, short x0, short y0, short x1,
...
static void
nk_sfml_fill_polygon(SDL_Surface *surface, const struct nk_vec2i *pnts, int count, struct nk_color col)
{
...
static void
nk_sfml_stroke_polygon(SDL_Surface *surface, const struct nk_vec2i *pnts, int count,
...
static void
nk_sfml_stroke_polyline(SDL_Surface *surface, const struct nk_vec2i *pnts,
...
static void
nk_sfml_fill_circle(SDL_Surface *surface, short x, short y, unsigned short w,
...
static void
nk_sfml_stroke_circle(SDL_Surface *surface, short x, short y, unsigned short w,
...
static void
nk_sfml_stroke_curve(SDL_Surface *surface, struct nk_vec2i p1,
...
static void
nk_sfml_draw_text(SDL_Surface *surface, short x, short y, unsigned short w, unsigned short h,
...
static void
nk_sfml_fill_rect_multi_color(SDL_Surface *surface, short x, short y, unsigned short w, unsigned short h,
...
static void
nk_sfml_clear(SDL_Surface *surface, struct nk_color col)
{
    nk_sdl_fill_rect(surface, 0, 0, surface->w, surface->h, 0, col);
}

static void
nk_sfml_blit(SDL_Surface *surface)
{
    SDL_UpdateRect(surface, 0, 0, 0, 0);
}

NK_API void
nk_sfml_render(struct nk_color clear)
{
...
static void
nk_sfml_clipbard_paste(nk_handle usr, struct nk_text_edit *edit)
{
    /* Not supported in SDL 1.2. Use platform specific code.  */
}

static void
nk_sfml_clipbard_copy(nk_handle usr, const char *text, int len)
{
    /* Not supported in SDL 1.2. Use platform specific code.  */
}

static float
nk_sfml_get_text_width(nk_handle handle, float height, const char *text, int len)
{
